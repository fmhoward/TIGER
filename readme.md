...
A trained model for gene signature prediction is available <a href = here.
from slideflow.mil.convert_features import *
convert_to_deeppt(bags = "/data/FEATURES/...", outdir = "/data/fred/FEATURES/CALGB/DEEPPT/", model_path = "/data/fred/slideflow_in_VM/model_files_deeppt/model_AE.pth")
