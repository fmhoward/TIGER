...
@register_torch
def uni(tile_px, **kwargs):
    from .uni import UNIFeatures
    return UNIFeatures(center_crop=(tile_px != 224), **kwargs)
...
class TorchFeatureExtractor(BaseFeatureExtractor):
    ...
    def __call__(self, obj, **kwargs):
        ...
        if isinstance(obj, sf.WSI):
            grid = features_from_slide_torch(self, obj, **kwargs)
